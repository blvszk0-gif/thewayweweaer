    ...
    <main className="min-h-screen bg-[color:var(--surface)] text-[color:var(--foreground)] font-antonio flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
        ...
        <div className="mt-[-4rem]">
          <h2 className="text-4xl font-black uppercase italic tracking-tighter mb-4">ZGUBIŁEŚ SQUAD?</h2>
          <p className="text-[18px] font-bold opacity-50 uppercase tracking-widest mb-8">Strona, której szukasz, została wycofana z dropu.</p>
          <Link
            href="/"
