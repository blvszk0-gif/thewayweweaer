...
const mainSubjects: SubjectItem[] = [
  { id: 'bluzy', label: 'BLUZY', image: 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?auto=format&fit=crop&q=80&w=800', link: '/shop/bluzy' },
  { id: 'koszulki', label: 'KOSZULKI', image: 'https://images.unsplash.com/photo-1521572267360-ee0c2909d518?auto=format&fit=crop&q=80&w=800', link: '/shop/koszulki' },
  { id: 'akcesoria', label: 'AKCESORIA', image: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&q=80&w=800', link: '/shop/akcesoria' },
  { id: 'lookbook', label: 'LOOKBOOK', image: 'https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?auto=format&fit=crop&q=80&w=800', link: '/lookbook' },
  { id: 'kolekcje', label: 'KOLEKCJE >', image: 'https://images.unsplash.com/photo-1490481651871-ab68de25d43d?auto=format&fit=crop&q=80&w=800', link: '/subjects?view=collections' },
];

const collections: SubjectItem[] = [
  { id: 'stare', label: 'THE WAY WE STARE', image: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&q=80&w=800', link: '/shop/stare' },
  { id: 'roll', label: 'THE WAY WE ROLL', image: 'https://images.unsplash.com/photo-1539109132381-31a15b2c686a?auto=format&fit=crop&q=80&w=800', link: '/shop/roll' },
  { id: 'bloom', label: 'THE WAY WE BLOOM', image: 'https://images.unsplash.com/photo-1496747611176-843222e1e57c?auto=format&fit=crop&q=80&w=800', link: '/shop/bloom' },
  { id: 'fly', label: 'THE WAY WE FLY', image: 'https://images.unsplash.com/photo-1475189778702-5ec9941484ae?auto=format&fit=crop&q=80&w=800', link: '/shop/fly' },
];
