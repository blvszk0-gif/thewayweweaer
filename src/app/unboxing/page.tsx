...
export default function UnboxingPage() {
  ...
  return (
    <main className="min-h-screen bg-[#fcfcfc] font-abel">
      <Header />

      <div className="container mx-auto px-6 pt-40 pb-20">
        <div className="text-center max-w-4xl mx-auto mb-24">
           <span className="text-[10px] font-black tracking-[0.5em] text-black/20 uppercase mb-4 block">ADHD Premium Experience</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-32">
           <div className="aspect-square bg-black rounded-[40px] overflow-hidden flex items-center justify-center relative group">
              ...
              <div className="absolute inset-0 bg-[url('https://placehold.co/800x800/000000/FFFFFF?text=PREMIUM+BOX')] bg-cover opacity-50 group-hover:scale-110 transition-transform duration-1000" />
           </div>
              ...
              {steps.map((step, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className="flex gap-6 items-start p-6 rounded-3xl hover:bg-black/5 transition-all"
                  >
        ...
        <div className="bg-black text-white rounded-[50px] p-16 md:p-24 text-center overflow-hidden relative group">
           ...
           <div className="relative z-10">
              <Camera size={48} className="mx-auto mb-8 text-white/20" />
