...
export default function MaintenancePage() {
  ...
  return (
    <main className="min-h-screen font-antonio flex items-center justify-center p-6 overflow-hidden">
      ...
      >
        ...
        <p className="text-[13px] md:text-base font-black uppercase tracking-[0.4em] text-[color:var(--foreground)]/40 mb-12 leading-relaxed px-12">
          {tEditorial('strona_jest_obecnie_w_trybie_prywatnym_p')}
        </p>
        ...
        <div className="flex flex-col items-center gap-6">
           ...
           <p className="text-[13px] font-bold uppercase tracking-widest opacity-20">{tEditorial('system_update_70_complete')}</p>
        </div>
