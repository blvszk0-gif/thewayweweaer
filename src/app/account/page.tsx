                ...
                {activeTab === 'ustawienia' && (
                  ...
                  >
                     ...
                     <div className="flex flex-wrap gap-6">
                        <button className="flex items-center gap-4 bg-white border border-[color:var(--border)] px-10 py-6 rounded-[30px] hover:bg-red-500 hover:text-white transition-all group shadow-sm">
                           ...
                           <div className="text-left">
                              ...
                              <p className="text-[13px] font-bold opacity-40 uppercase tracking-widest">Bezpowrotne usunięcie danych</p>
                           </div>
                        </button>
                        <button className="flex items-center gap-4 bg-white border border-[color:var(--border)] px-10 py-6 rounded-[30px] hover:bg-black hover:text-white transition-all group shadow-sm">
                           <BellOff size={24} className="opacity-40 group-hover:text-white" />
                           <div className="text-left">
                              <p className="font-black uppercase text-lg">Wypisz z newslettera</p>
                              <p className="text-[13px] font-bold opacity-40 uppercase tracking-widest">Przestań otrzymywać powiadomienia</p>
                           </div>
                        </button>
                     </div>
                  </motion.div>
