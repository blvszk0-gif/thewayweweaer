    ...
    <main className="min-h-screen bg-[color:var(--surface)] text-[color:var(--foreground)] font-antonio flex flex-col justify-between">
      ...
      <div className="container mx-auto px-6 pt-40 pb-20 max-w-xl">
        <Link href="/account" className="inline-flex items-center gap-2 text-sm font-black uppercase opacity-50 hover:opacity-100 transition-opacity mb-8">
          <ArrowLeft size={16} /> Powrót do konta
        </Link>
        ...
        <div className="bg-[color:var(--surface-muted)] p-10 rounded-[40px] border border-[color:var(--border)] shadow-2xl text-center space-y-6">
          ...
          <h1 className="text-3xl font-black uppercase italic tracking-tighter">Usuwanie Konta</h1>
          <p className="text-sm font-bold opacity-60 uppercase tracking-widest leading-relaxed">
            Czy chcesz bezpowrotnie usunąć swoje konto oraz powiązane dane osobowe z naszego systemu?
          </p>
            ...
            >
              {isSuccess ? (
                <div className="space-y-4 py-6">
                  ...
                  <h3 className="text-2xl font-black uppercase italic">Konto Zostało Usunięte</h3>
                  <p className="text-xs font-bold opacity-50 uppercase tracking-widest">
                    Twoje dane zostały pomyślnie usunięte. Przekierowywanie na stronę główną...
                  </p>
                </div>
              ) : (
                <>
                  ...
                  <h3 className="text-2xl font-black uppercase italic">Czy na pewno usunąć konto?</h3>
                  <p className="text-xs font-bold opacity-60 uppercase tracking-widest leading-relaxed">
                    Ta operacja jest nieodwracalna. Twoje konto oraz historia zostaną trwale usunięte również z bazy danych.
                  </p>
