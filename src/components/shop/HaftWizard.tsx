          ...
          <div className="min-h-[350px]">
            ...
            {step === 2 && (
              <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}>
                ...
                <div className="bg-white border-2 border-dashed border-black/10 rounded-3xl p-12 flex flex-col items-center justify-center gap-6">
            ...
            {step === 3 && (
              <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}>
                ...
                <div className="space-y-6">
                  ...
                  <button
                    onClick={nextStep}
                    className="w-full bg-black text-white py-5 rounded-full font-black uppercase tracking-widest text-sm flex items-center justify-center gap-2"
                  >
              ...
              <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}>
                {!isLoggedIn ? (
                  <div className="text-center space-y-8 py-8">
                    ...
                    <div>
                      <h3 className="text-3xl font-black uppercase tracking-tighter italic mb-4">Wymagane logowanie</h3>
