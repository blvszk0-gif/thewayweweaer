...
export const CartView = () => {
  return (
    <div className="bg-black py-32 container mx-auto px-6">
        ...
        <div className="flex-1">
          ...
          <div className="space-y-8 border-t border-white/10 pt-8">
            <div className="flex gap-6 items-center">
              <div className="w-24 h-32 bg-white/5 border border-white/10 rounded-2xl overflow-hidden grayscale">
              ...
              <div className="flex-1">
                ...
                <p className="text-white/30 text-xs font-bold uppercase tracking-widest mt-1">Rozmiar: M</p>
                <div className="mt-4 flex justify-between items-end">
                   <div className="flex border border-white/20 rounded-full px-4 py-1 gap-4 items-center">
        ...
        <div className="w-full lg:w-96 space-y-8">
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 space-y-6">
            ...
            <div className="space-y-3 border-b border-white/10 pb-6">
              <div className="flex justify-between text-sm font-bold uppercase tracking-widest text-white/50">
                <span>Artykuły</span>
                <span className="text-white">349 PLN</span>
              </div>
              <div className="flex justify-between text-sm font-bold uppercase tracking-widest text-white/50">
                <span>Dostawa</span>
                <span className="text-white font-black italic">+ CENA DOSTAWY</span>
              </div>
            </div>

            <div className="flex justify-between items-end">
               <span className="text-xs font-bold text-white/30 uppercase tracking-[0.2em]">Suma całkowita</span>
               <span className="text-4xl font-black tracking-tighter underline underline-offset-8">349 PLN</span>
            </div>

            <button className="w-full bg-white text-black py-5 rounded-full font-black uppercase tracking-widest hover:bg-white/90 transition-all flex items-center justify-center gap-3">
          ...
          <div className="flex flex-col gap-4">
             <div className="flex items-center gap-4 bg-white/5 p-6 rounded-2xl border border-white/10">
                ...
                <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-white/50 leading-relaxed">
