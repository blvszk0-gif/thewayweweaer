...
export const LoginForm = () => {
  ...
  return <div className="w-full max-w-md mx-auto font-antonio">
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-[color:var(--surface)] rounded-[40px] p-12 shadow-2xl border border-[color:var(--border)] text-center">
      <h1 className="text-3xl font-black uppercase tracking-tighter italic mb-5 text-[color:var(--foreground)]">TWWW Club</h1>
      <p className="text-[14px] font-bold uppercase opacity-50 tracking-widest leading-relaxed text-[color:var(--foreground)] mb-10">Zaloguj się lub utwórz konto bezpiecznie w Shopify. Zakupy jako gość pozostają dostępne.</p>
